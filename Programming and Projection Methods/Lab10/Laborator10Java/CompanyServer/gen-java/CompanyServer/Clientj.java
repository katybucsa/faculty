...
public class Clientj implements org.apache.thrift.TBase<Clientj, Clientj._Fields>, java.io.Serializable, Cloneable, Comparable<Clientj> {
  ...
  public Clientj setClient_id(int client_id) {
    this.client_id = client_id;
    setClient_idIsSet(true);
    return this;
  }
