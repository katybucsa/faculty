...
class Run {
public:
	static void run(std::string cuvinte_rezervate, std::string operatori, std::string separatori, std::string automat_const,
		std::string automat_identif, std::string fileCerc, std::string fileCmmdc, std::string fileSuma, std::string outFile) {
		...
		Automat a_cst = Automat(automat_const);
		Automat a_identif = Automat(automat_identif);
		Analizator analizator{ a_cst,a_identif };
		std::string file;
		int cmd;
		while (true) {
