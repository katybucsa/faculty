...
public class DBConnection {
    ...
    private Connection getNewConnection() {
        logger.traceEntry();
        String driver = properties.getProperty("game.jdbc.driver");
        String url = properties.getProperty("game.jdbc.url");
        String user = properties.getProperty("game.jdbc.user");
        String password = properties.getProperty("game.jdbc.password");
