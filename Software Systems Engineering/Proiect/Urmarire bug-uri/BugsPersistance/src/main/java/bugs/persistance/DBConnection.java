...
public class DBConnection {
    ...
    private Connection getNewConnection(){
        logger.traceEntry();
        String driver=properties.getProperty("bugs.jdbc.driver");
        String url=properties.getProperty("bugs.jdbc.url");
        String user=properties.getProperty("bugs.jdbc.user");
        String password=properties.getProperty("bugs.jdbc.password");
