...
segment code use32 class=code
    start:
        ...
        mov eax,[a]; punem in eax valoarea lui a
        add eax,[b]; eax=eax+b=a+b 
        mov [rezultat],eax; punem in variabila rezultat suma numerelor
        
        push dword [a]; pe stiva se pune valoarea variabilei a
        push dword format
        ...
        push dword plus; pe stiva sepune adresa string-ului, nu valoarea sa
