...
public class Controller extends UnicastRemoteObject implements IObserver, Serializable {
    ...
    public void startGame(int poz1, int poz2) {
        server.startGame(player, poz1, poz2);
    }
    ...
    public void update(Notification notif) throws AppException {
        Platform.runLater(() -> {
            ...
            if (notif.getType() == Type.GUESSED_ONEP) {
                listener.guessedPosition(notif.getAdversarPoz());
            }
