...
public class BookingRepository implements IBookingRepository {
    ...
    @Override
    public Booking findOne(Pair<Client, Ride> clientRidePair) {
        return null;
    }

    @Override
    public void save(Booking booking) throws ValidationException {
    ...
    @Override
    public void delete(Pair<Client, Ride> clientRidePair) {
